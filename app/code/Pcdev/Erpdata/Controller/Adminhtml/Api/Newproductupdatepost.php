...
class Newproductupdatepost extends \Magento\Backend\App\Action
{
	...
	protected $_publicActions = ['newproductupdatepost'];
    ...
    {		
		...
		$logwriter = new \Zend_Log_Writer_Stream(BP . '/var/log/NewProductUpdate.log');
		...
		if(isset($params['updatenewproducts']) && $params['requestnewsync'] == 1 && !empty($params['updatenewproducts'])){
